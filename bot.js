...
client.on('ready', () => {
  client.user.setGame('#help | #inv','https://www.twitch.tv/peery13');
  console.log('---------------');
...
.setColor("#9B59B6")
.addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/hzEDVHA ...*")
...
client.on('message', message => {
    ...
    .setTitle(`Click Here To Add FalconBot `)
    .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=511261063447052298&permissions=8&scope=bot`)
    .setThumbnail("https://images-ext-2.discordapp.net/external/9gszE35tl58vyNMUjILqHVRxjdcAiHan9bzwD87R1WE/%3Fsize%3D2048/https/cdn.discordapp.com/avatars/511261063447052298/2bb2fec5025ef6086a5d7e48884c3834.png?width=241&height=241")        
 message.channel.sendEmbed(embed);
   }
});
