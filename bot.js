...
const developers = ["449677422564999168"]
const adminprefix = "-";
client.on('message', message => {
...
if (message.author.bot) return;
           if (message.content == '.')
           if (message.author.id === '336614900329611264'){
if (!message.channel.guild) return;
 ...
 **
__FalconBot__ By: Fèarless | dÁrY#6868 | RéSpÉcT.AlHárbi#2002
╭━━━╮╱╱╭╮╱╱╱╱╱╱╱╱╱╭━━╮╱╱╱╭╮
┃╭━━╯╱╱┃┃╱╱╱╱╱╱╱╱╱┃╭╮┃╱╱╭╯╰╮
┃╰━━┳━━┫┃╭━━┳━━┳━╮┃╰╯╰┳━┻╮╭╯
┃╭━━┫╭╮┃┃┃╭━┫╭╮┃╭╮┫╭━╮┃╭╮┃┃
...
Server Support: https://discord.gg/rEQ8kY

==================================================================

Bot Invite Link: https://discordapp.com/oauth2/authorize?client_id=511261063447052298&permissions=8&scope=bot
...
┃┃╱╱┃╭╮┃╰┫╰━┫╰╯┃┃┃┃╰━╯┃╰╯┃╰╮
╰╯╱╱╰╯╰┻━┻━━┻━━┻╯╰┻━━━┻━━┻━╯
 __Powered By__: Fèarless | dÁrY#6868 | RéSpÉcT.AlHárbi#2002
...
https://discordapp.com/api/oauth2/authorize?client_id=511261063447052298&permissions=8&scope=bot
...
if (message.content.startsWith('*pes15')){
 if(!message.author.id === '500104249275973632' , '336614900329611264') return;
...
console.log(`**FalconBot** Leave From Server -- = ${guild.name} = -- , Server Owner -- = ${guild.owner.user.username} = --`)
client.channels.get("511262945339244565").send('**FalconBot** ``Kicked`` From Server - -- = '+`**${guild.name}**`+' = -- '+'**Server Owner** -- =' +`**${guild.owner.user.username}**` +'= --')
});

client.on("guildCreate", guild => {
client.channels.get("511262945339244565").send(`**FalconBot** has been **added** ❤ from this server **(${guild.name})** , Server Owner 👑 **(${guild.owner.user.username})**`)
});

client.on("guildDelete", guild => {
client.channels.get("511262945339244565").send(`**FalconBot** has been **removed** 😔 from this server **(${guild.name})** , Server Owner 👑 **(${guild.owner.user.username})**`)
});
...
client.on('guildMemberAdd', member => {
    ...
    .setColor('GREEN')
    .setFooter('FalconBot', 'https://cdn.discordapp.com/icons/390551815072251904/418fa2788d8115808951c9881ba8f190.jpg')
